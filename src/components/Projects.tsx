...
const Projects = () => {
  ...
  if (loading) {
    return (
      <section id="projects" className="relative overflow-hidden bg-warm/20 py-24 px-6 lg:px-8 min-h-[400px] flex items-center justify-center">
    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <div className="mb-20 text-center fade-in-up">
          ...
          <p className="mx-auto max-w-3xl text-xl text-primary-dark/80 leading-relaxed">
