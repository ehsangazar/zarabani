              ...
              <div className="space-y-8">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:zara.bani@example.com" className="text-purple-600 hover:text-purple-700 font-medium">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-1">Currently pursuing my Master's</p>
                    <p className="text-gray-800 font-medium">Birmingham City University</p>
                    <p className="text-gray-600">User Experience Design</p>
                  </div>
                </div>
              </div>
            </div>
