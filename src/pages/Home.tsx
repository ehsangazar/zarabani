...
export default function Home() {
  return <div className="ms-page">
    ...
    <header className="ms-intro ms-home-intro"><div className="ms-home-intro-copy"><p className="ms-eyebrow">Zara Bani · London, UK</p><h1>Product & <span>UX designer</span></h1><p>I'm an end-to-end Product Designer and storyteller, focused on turning user pain into product decisions that balance usability, feasibility, and business goals.</p><p>I help teams move from insight to action by aligning user needs with practical constraints, making informed trade-offs, and shaping clear, usable solutions across B2B SaaS and B2C products. My experience includes complex, data-heavy platforms, multi-role systems, and SaaS products, where clarity, scalability, and usability are critical.</p><Link className="ms-text-link ms-primary-link" to="/projects">Explore Featured Work <span aria-hidden="true">↗</span></Link>
